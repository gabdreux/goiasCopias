...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD2A621);
  late Color secondary = const Color(0xFFFCC26F);
  late Color tertiary = const Color(0xFFFCC26F);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF1F1E1E);
  late Color secondaryText = const Color(0xFF5A5C60);
  late Color primaryBackground = const Color(0xFFE7E8F2);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFFB549);
  late Color accent2 = const Color(0xFFFCC26F);
  ...
  late Color header = Color(0xFF292A33);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryBackground = const Color(0xFF292A33);
  late Color accent1 = const Color(0xFFFFB549);
  late Color accent2 = const Color(0xFFFCC26F);
  late Color accent3 = const Color(0x4CEE8B60);
